...
def save_info(scheduler:Scheduler):
    ...
    str_list = [[cpu_rate,gpu_rate,scheduler.reschedule_num,scheduler.fail_num,success_num,scheduler.task_cache_num,scheduler.task_no_cache_num,scheduler.node_cache_num,scheduler.node_no_cache_num,type(scheduler).__name__,scheduler.get_can_predict(),scheduler.get_time()]]
