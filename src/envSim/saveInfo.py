...
def save_info(scheduler: Scheduler):
    ...
    args_dict["task_cache_num"] = scheduler.get_task_cache_num()
    args_dict["task_no_cache_num"] = scheduler.get_task_no_cache_num()
    args_dict["node_cache_num"] = scheduler.get_node_cache_num()
    args_dict["node_no_cache_num"] = scheduler.get_node_no_cache_num()
